...
function VerifyContent() {
  ...
  return (
    <motion.div 
      ...
      className="w-full max-w-md bg-[#111]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8"
    >
      {success ? (
        ...
        <>
          ...
          <form onSubmit={handleVerify} className="space-y-4">
            ...
            <button 
              disabled={loading} 
              className="w-full bg-blue-600 hover:bg-blue-500 text-white py-3 rounded-lg font-bold flex justify-center items-center disabled:opacity-50"
            >
